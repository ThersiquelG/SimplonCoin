...
public class CCourant extends Comptes {
	...
	public void virement(PEL receveur, double montant) {
		if(montant > getSolde()) {
			System.out.println("Vous n'avez pas assez d'argent.");
		} else {
	...
	public void crédit(CCourant receveur, double montant) {

		receveur.solde = receveur.getSolde() + montant ;

		System.out.println("Vous avez rajouté : " +  montant + " euros sur votre compte.");
		System.out.println("----------------------------");
		System.out.println("Vous avez maintenant : " + (getSolde()) + " euros.");
	}
